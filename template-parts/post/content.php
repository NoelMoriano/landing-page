	...
	<section class="content-banner-primary-blog-article"  style="background: url(<?php the_post_thumbnail( 'twentyseventeen-featured-image' );?>) !important; background-size: cover !important;">
